...
{
    public partial class Surgical_Consump_List : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl_OP_Id.Text = sequenceService.GetById(7).Prefix + "/" + Session["OperationId"].ToString() + "/" + Common_Controle.Common_Methods.GetCurrentFinancialYear().ToString(); 
